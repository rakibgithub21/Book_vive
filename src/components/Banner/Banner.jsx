    ...
    return (
        <div className='flex flex-col gap-5 md:gap-0 md:text-start md:flex-row items-center text-center justify-between md:p-40 p-5 bg-[#1313130d] rounded-lg'>
            <div className='md:w-[526px] pace-y-4 '>
                ...
                <button onClick={viewTheList} className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group">
